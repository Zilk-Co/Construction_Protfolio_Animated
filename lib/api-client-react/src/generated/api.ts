...
export const updateProjectImage = async (id: number,
  ...
  return customFetch<ProjectImage>(getUpdateProjectImageUrl(id,imageId),
  {
    ...
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(projectImageUpdate)
  }
);}
...
export const createMachinery = async (machineryInput: MachineryInput, options?: RequestInit): Promise<MachineryItem> => {
  ...
  return customFetch<MachineryItem>(getCreateMachineryUrl(),
  {
    ...
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(machineryInput)
  }
);}
...
const {query: queryOptions, request: requestOptions} = options ?? {};
  ...
  const queryKey =  queryOptions?.queryKey ?? getGetMachineryQueryKey(slug);
   ...
   return  { queryKey, queryFn, enabled: slug !== null && slug !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getMachinery>>, TError, TData> & { queryKey: QueryKey }
}
 ...
 */
export const listServices = async (params?: ListServicesParams, options?: RequestInit): Promise<ServicesItem[]> => {

  return customFetch<ServicesItem[]>(getListServicesUrl(params),
  {
    ...options,
    method: 'GET'
...
export const getCreateServicesUrl = () => {
 ...
 */
export const createServices = async (servicesInput: ServicesInput, options?: RequestInit): Promise<ServicesItem> => {

  return customFetch<ServicesItem>(getCreateServicesUrl(),
  {
    ...options,
    method: 'POST',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
    body: JSON.stringify(servicesInput)
  }
);}
...
export const getCreateServicesMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createServices>>, TError,{data: BodyType<ServicesInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof createServices>>, TError,{data: BodyType<ServicesInput>}, TContext> => {

const mutationKey = ['createServices'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof createServices>>, {data: BodyType<ServicesInput>}> = (props) => {
          const {data} = props ?? {};

          return  createServices(data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type CreateServicesMutationResult = NonNullable<Awaited<ReturnType<typeof createServices>>>
    export type CreateServicesMutationBody = BodyType<ServicesInput>
    export type CreateServicesMutationError = ErrorType<unknown>

    /**
 * @summary Create a service
 */
export const useCreateServices = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof createServices>>, TError,{data: BodyType<ServicesInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof createServices>>,
        TError,
        {data: BodyType<ServicesInput>},
        TContext
      > => {
      return useMutation(getCreateServicesMutationOptions(options));
    }

export const getGetServicesUrl = (slug: string,) => {
 ...
 */
export const getServices = async (slug: string, options?: RequestInit): Promise<ServicesItem> => {

  return customFetch<ServicesItem>(getGetServicesUrl(slug),
  {
    ...options,
    method: 'GET'
...
export const getGetServicesQueryKey = (slug: string,) => {
    return [
    `/api/services/${slug}`
    ] as const;
    }
...
export const getGetServicesQueryOptions = <TData = Awaited<ReturnType<typeof getServices>>, TError = ErrorType<void>>(slug: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getServices>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {

const {query: queryOptions, request: requestOptions} = options ?? {};

  const queryKey =  queryOptions?.queryKey ?? getGetServicesQueryKey(slug);



    const queryFn: QueryFunction<Awaited<ReturnType<typeof getServices>>> = ({ signal }) => getServices(slug, { signal, ...requestOptions });





   return  { queryKey, queryFn, enabled: slug !== null && slug !== undefined, ...queryOptions} as UseQueryOptions<Awaited<ReturnType<typeof getServices>>, TError, TData> & { queryKey: QueryKey }
}

export type GetServicesQueryResult = NonNullable<Awaited<ReturnType<typeof getServices>>>
export type GetServicesQueryError = ErrorType<void>
...
export function useGetServices<TData = Awaited<ReturnType<typeof getServices>>, TError = ErrorType<void>>(
 slug: string, options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getServices>>, TError, TData>, request?: SecondParameter<typeof customFetch>}

 ):  UseQueryResult<TData, TError> & { queryKey: QueryKey } {

  const queryOptions = getGetServicesQueryOptions(slug,options)
...
export const getUpdateServicesUrl = (id: number,) => {




  return `/api/services/${id}/update`
}

/**
 * @summary Update a service
 */
export const updateServices = async (id: number,
    servicesInput: ServicesInput, options?: RequestInit): Promise<ServicesItem> => {

  return customFetch<ServicesItem>(getUpdateServicesUrl(id),
  {
    ...options,
    method: 'PUT',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getUpdateServicesMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateServices>>, TError,{id: number;data: BodyType<ServicesInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof updateServices>>, TError,{id: number;data: BodyType<ServicesInput>}, TContext> => {

const mutationKey = ['updateServices'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof updateServices>>, {id: number;data: BodyType<ServicesInput>}> = (props) => {
          const {id,data} = props ?? {};

          return  updateServices(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type UpdateServicesMutationResult = NonNullable<Awaited<ReturnType<typeof updateServices>>>
    export type UpdateServicesMutationBody = BodyType<ServicesInput>
    export type UpdateServicesMutationError = ErrorType<unknown>

    /**
 * @summary Update a service
 */
export const useUpdateServices = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof updateServices>>, TError,{id: number;data: BodyType<ServicesInput>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof updateServices>>,
        TError,
        {id: number;data: BodyType<ServicesInput>},
        TContext
      > => {
      return useMutation(getUpdateServicesMutationOptions(options));
    }

export const getToggleServicesPublishUrl = (id: number,) => {




  return `/api/services/${id}/publish`
}

/**
 * @summary Toggle service published status
 */
export const toggleServicesPublish = async (id: number,
    publishToggle: PublishToggle, options?: RequestInit): Promise<ServicesItem> => {

  return customFetch<ServicesItem>(getToggleServicesPublishUrl(id),
  {
    ...options,
    method: 'PATCH',
    headers: { 'Content-Type': 'application/json', ...options?.headers },
...
export const getToggleServicesPublishMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof toggleServicesPublish>>, TError,{id: number;data: BodyType<PublishToggle>}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof toggleServicesPublish>>, TError,{id: number;data: BodyType<PublishToggle>}, TContext> => {

const mutationKey = ['toggleServicesPublish'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof toggleServicesPublish>>, {id: number;data: BodyType<PublishToggle>}> = (props) => {
          const {id,data} = props ?? {};

          return  toggleServicesPublish(id,data,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type ToggleServicesPublishMutationResult = NonNullable<Awaited<ReturnType<typeof toggleServicesPublish>>>
    export type ToggleServicesPublishMutationBody = BodyType<PublishToggle>
    export type ToggleServicesPublishMutationError = ErrorType<unknown>

    /**
 * @summary Toggle service published status
 */
export const useToggleServicesPublish = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof toggleServicesPublish>>, TError,{id: number;data: BodyType<PublishToggle>}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof toggleServicesPublish>>,
        TError,
        {id: number;data: BodyType<PublishToggle>},
        TContext
      > => {
      return useMutation(getToggleServicesPublishMutationOptions(options));
    }

export const getDeleteServicesUrl = (id: number,) => {
 ...
 */
export const deleteServices = async (id: number, options?: RequestInit): Promise<void> => {

  return customFetch<void>(getDeleteServicesUrl(id),
  {
    ...options,
    method: 'DELETE'
...
export const getDeleteServicesMutationOptions = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteServices>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
): UseMutationOptions<Awaited<ReturnType<typeof deleteServices>>, TError,{id: number}, TContext> => {

const mutationKey = ['deleteServices'];
const {mutation: mutationOptions, request: requestOptions} = options ?
      options.mutation && 'mutationKey' in options.mutation && options.mutation.mutationKey ?
      options
      : {...options, mutation: {...options.mutation, mutationKey}}
      ...
      const mutationFn: MutationFunction<Awaited<ReturnType<typeof deleteServices>>, {id: number}> = (props) => {
          const {id} = props ?? {};

          return  deleteServices(id,requestOptions)
        }
  ...
  return  { mutationFn, ...mutationOptions }}
    ...
    export type DeleteServicesMutationResult = NonNullable<Awaited<ReturnType<typeof deleteServices>>>

    export type DeleteServicesMutationError = ErrorType<unknown>

    /**
 * @summary Delete a service
 */
export const useDeleteServices = <TError = ErrorType<unknown>,
    TContext = unknown>(options?: { mutation?:UseMutationOptions<Awaited<ReturnType<typeof deleteServices>>, TError,{id: number}, TContext>, request?: SecondParameter<typeof customFetch>}
 ): UseMutationResult<
        Awaited<ReturnType<typeof deleteServices>>,
        TError,
        {id: number},
        TContext
      > => {
      return useMutation(getDeleteServicesMutationOptions(options));
    }
